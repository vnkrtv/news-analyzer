...
from news_analyzer.modules.ner_extractor.natasha_ner_extractor import NatashaNerExtractor
from news_analyzer.modules.tonality_determinant.dostoevsky_tonality_determinant import DostoevskyTonalityDeterminant
